...
const PrivacyPolicy = () => {
  return (
    <div>
      ...
      <p>
        Nuno Vinagreiro ("us", "we", or "our") operates the
        https://www.nunovinagreiro.com website (the "Service").
      </p>
      <p>
      ...
      <ul>
        <li>
          <strong>Session Cookies.</strong> We may use Session Cookies to
          operate our Service.
        </li>
        <li>
      ...
      <p>
        We may use the "visitor action pixels" from Facebook Inc (1 Hacker Way,
        ...
        clicking on a Facebook ad. This enables us to measure the effectiveness
        of Facebook ads for statistical and market research purposes. The data
        collected in this way is anonymous to us, i.e. we do not see the
        personal data of individual users. However, this data is stored and
        ...
        partners to place ads on and off Facebook. A cookie may also be stored
        on your computer for these purposes. The legal basis for the use of this
        service is Art. 6 paragraph 1 sentence 1 letter f GDPR. You can object
        to the collection of your data by Facebook pixel, or to the use of your
        data for the purpose of displaying Facebook ads by contacting the
        following address: https://www.facebook.com/settings?tab=ads. Facebook
        is certified under the Privacy Shield Agreement and thus guarantees
      ...
      <ul>
        ...
        <li>To protect and defend the rights or property of Nuno Vinagreiro</li>
        <li>
      ...
      <ul>
        ...
        <li>
          ...
          <p>Amplitude is an analytics service provided by Amplitude, Inc.</p>
          <p>
            For more information on the privacy practices of Amplitude, please
            visit the Amplitude Privacy & Terms web page:
      ...
      <ul>
        <li>By email: nunocmav@gmail.com</li>
      </ul>
      <h1>{" "}</h1>
    </div>
  );
